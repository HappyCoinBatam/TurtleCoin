...
For example:
BatamCoind --print-genesis-tx --genesis-block-reward-address TRTLv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in BatamCoind. It is used to know what timestamp
...
const char     CRYPTONOTE_NAME[]                             = "BatamCoin";
...
const char     LATEST_VERSION_URL[]                          = "http://latest.batamcoin.lol";
const std::string LICENSE_URL                                = "https://github.com/batamcoin/batamcoin/blob/master/LICENSE";

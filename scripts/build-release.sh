...
function usage()
{
    ...
    echo "and generates the checksum files of the BatamCoin tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/batamcoin/batamcoin.git"
CLONE_DIR="$BUILD_DIRECTORY/batamcoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/batamcoin-releases"
DYNAMIC_RELEASE="batamcoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="batamcoin-${TAG_VERSION}-linux-staticboost-CLI"
